...
if [[ ! -z "$INPUT_SKIP_CHECK" ]]; then
  SKIP_CHECK_FLAG="--skip-check $INPUT_SKIP_CHECK,CKV_AWS_5,CKV_AWS_16,CKV_AWS_17,CKV_AWS_19,CKV_AWS_20,CKV_AWS_21,CKV_AWS_29,CKV_AWS_38,CKV_AWS_39,CKV_AWS_42,CKV_AWS_47,CKV_AWS_49,CKV_AWS_52,CKV_AWS_144"
else
  SKIP_CHECK_FLAG="--skip-check CKV_AWS_5,CKV_AWS_16,CKV_AWS_17,CKV_AWS_19,CKV_AWS_20,CKV_AWS_21,CKV_AWS_29,CKV_AWS_38,CKV_AWS_39,CKV_AWS_42,CKV_AWS_47,CKV_AWS_49,CKV_AWS_52,CKV_AWS_144"
fi
